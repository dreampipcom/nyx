...
export const ALTERNATE = (path) => [
  {
    href: process.env.SITE_URL || 'https://www.remometro.com' + path,
    hreflang: 'x-default',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/en' + path,
    hreflang: 'en',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/it-it' + path,
    hreflang: 'it-it',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/pt-br' + path,
    hreflang: 'pt-br',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/es-es' + path,
    hreflang: 'es-es',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/de-de' + path,
    hreflang: 'de-de',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/fr-fr' + path,
    hreflang: 'fr-fr',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/es-es' + path,
  ...
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/ro' + path,
    hreflang: 'ro',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/pl-pl' + path,
    hreflang: 'pl-pl',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/cs-cz' + path,
    hreflang: 'cs-cz',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/sv-se' + path,
    hreflang: 'sv-se',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/et-ee' + path,
    hreflang: 'et-ee',
  },
  {
    href: process.env.SITE_URL || 'https://www.remometro.com/ja-jp' + path,
    hreflang: 'ja-jp',
  },
]
