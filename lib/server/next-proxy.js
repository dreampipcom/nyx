 ...
 */
var httpProxyMiddleware = function (req, res, httpProxyOptions) {
    if (httpProxyOptions === void 0) { httpProxyOptions = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var pathRewrite = httpProxyOptions.pathRewrite, onProxyInit = httpProxyOptions.onProxyInit, serverOptions = __rest(httpProxyOptions, ["pathRewrite", "onProxyInit"]);
                    /**
                    ...
                    if (pathRewrite) {
                        req.url = (0, exports.rewritePath)(req.url, pathRewrite);
                    }
                    ...
                    proxy
                        ...
                        .once("error", reject)
                        .web(req, res, __assign({ changeOrigin: true }, serverOptions));
                })];
        });
    });
};
